...
#define RNG_N 624
#define RNG_M 397
#define MATRIX_A_RNG 0x9908b0dfUL   /* constant vector a */
...
/* generates a random number on [0,0xffffffff]-interval */
#define genrand_int31(state) ((int32_t)(genrand_int32(gMatchState)>>1))

/* These real versions are due to Isaku Wada, 2002/01/09 added */
/* generates a random number on [0,1]-real-interval */
#define genrand_real1(state) (genrand_int32(gMatchState)*(1.0/4294967295.0))

/* generates a random number on [0,1)-real-interval */
#define genrand_real2(state) (genrand_int32(gMatchState)*(1.0/4294967296.0))

/* generates a random number on (0,1)-real-interval */
#define genrand_real3(state) ((((double)genrand_int32(gMatchState))+0.5)*(1.0/4294967296.0))

/* generates a random number on [0,1) with 53-bit resolution*/
#define genrand_res53(state) (((genrand_int32(gMatchState)>>5)*67108864.0+(genrand_int32(gMatchState)>>6))*(1.0/9007199254740992.0))
